...
async def dumtyer(dumtter):
    await dumtter.edit("• g∂яιvε •"
                       "\n• .gdauth  : Generate Token Only Once."
                       "\n• .gdreset : Reset Token."
                       "\n• .gd : Upload File to GDrive."
                       "\n• .gdabort : Abort Up or Down."
                       "\n• .gdlist : Get List Files."
                       "\n• .gdf mkdir : Create Dir."
                       "\n• .gdf chck : Check GDrive."
                       "\n• .gdf rm : Delete Files."
                       "\n• .gdfset put : Change Upload Dir."
                       "\n• .gdfset rm : Remove set ParentID."
                       "\n• .gdfset : Put into **G_DRIVE_FOLDER_ID**.")
CMD_HELP.update(
    {
        "gdrive": 
        "• g∂яιvε •"
